...
export default function RasaIbuFooter() {
    return (
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-[#E5E1D8]/20 pb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-[#B2BCA2] leading-relaxed">
                            Menghadirkan kehangatan masakan rumah ke meja makan Anda. Praktis, sehat, dan penuh cinta.
                        </p>
                        <div className="flex gap-4 pt-4">
                            <a href="#" className="w-10 h-10 rounded-full bg-[#E5E1D8]/10 flex items-center justify-center hover:bg-[#B2BCA2] hover:text-[#2D3A2D] transition-all">
