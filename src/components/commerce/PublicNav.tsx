...
export default function PublicNav({ navLinks, whatsapp, instagramHandle = '@rasaibu', socialLinks, config }: PublicNavProps) {
    ...
    const platforms = [
        { key: 'shopeeFood', label: 'Shopee', icon: '🛍️' },
        { key: 'grabFood', label: 'Grab', icon: '🛵' },
        { key: 'goFood', label: 'GoFood', icon: '❤️' },
        { key: 'tokopedia', label: 'TokPed', icon: '🛒' },
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {platforms.map((p) => (
                                        <a
                                            ...
                                            className="flex items-center gap-3 p-3.5 bg-white border border-[#E5E1D8] rounded-2xl shadow-sm active:scale-95 transition-all"
                                        >
